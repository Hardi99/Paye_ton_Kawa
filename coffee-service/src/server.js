...
mongoose.connect(process.env.COFFEE_SERVICE_DB_URI, { useNewUrlParser: true, useUnifiedTopology: true })
  .then(() => {
...
app.use('/api', authenticateJWT, coffeeRoutes); // Protéger les routes coffees avec le middleware d'authentification
