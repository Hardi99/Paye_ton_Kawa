...
mongoose.connect(process.env.CLIENT_SERVICE_DB_URI, { useNewUrlParser: true, useUnifiedTopology: true })
  .then(() => {
...
app.use('/api', authenticateJWT, clientRoutes); // Protéger les routes clients avec le middleware d'authentification
